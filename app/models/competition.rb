...
class Competition < ApplicationRecord
  ...
  has_many :score_list_conditions, dependent: :destroy, class_name: 'Score::ListCondition'
  ...
  has_many :publishings, class_name: 'FireSportStatistics::Publishing', dependent: :destroy
